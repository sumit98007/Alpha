...
- Expand the floating window from the icon’s edge using a spring-like scale and fade over `360–440ms`; keep simple hover and feedback transitions within `160–220ms`.
...
The extension mark is a deep-blue rounded square containing an orange circle and the black
four-point Alpha spark used by the floating launcher. Keep the geometry centered and use no colors
outside the core palette. The editable source is `brand/alpha-extension-icon.svg`; Chrome-ready
16px, 32px, 48px, and 128px PNGs are generated by `scripts/generate-extension-icons.mjs`.
